...
// if hotter than 80 and raining, console log, >=, ===
// if between 60 and 80 and raining, console log <>, ===
// if its below 60 console log <, ===
...
// Create a while loop, score is less than passingScore 
// console log
// add one to score
...
////////// PROBLEM 10 //////////
// Using the "not" operator (!), change the current value of changeMyMind to 
//true (it should currently be set to false due to the if-else statement in Problem 9). 
